...
public class HomeAspect {
		...
		public Object allPost(ProceedingJoinPoint joinPoint) throws Throwable{
			...
			try {  
				...
				// client측 : pageNum, DB측 : totalCount 
