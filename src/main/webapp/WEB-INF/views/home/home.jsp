          ...
          <div class="col-md-10">
            ...
            <div class="job-search">
              <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link bg-warning text-white py-3" id="pills-job-tab" data-toggle="pill" href="" role="tab" aria-controls="pills-job" aria-selected="true">&nbsp;&nbsp;&nbsp;&nbsp;In Post&nbsp;&nbsp;&nbsp;&nbsp;</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link bg-warning text-white py-3" id="pills-job-tab" data-toggle="pill" href="" role="tab" aria-controls="pills-job" aria-selected="true">&nbsp;&nbsp;&nbsp;&nbsp;In Web&nbsp;&nbsp;&nbsp;&nbsp;</a>
                </li> 
              </ul>
                ...
                <div class="tab-pane fade show active" id="pills-job" role="tabpanel" aria-labelledby="pills-job-tab">
                  ...
                  <form name="searchBook" action="<c:url value='/home/searchBook'/>" method="post">
                    <div class="row">
                      ...
                      <div class="col-md-6 col-lg-3 mb-3 mb-lg-0">
                        <input type="submit" class="btn bg-warning text-white btn-block" value="Search a book">
                      </div>
